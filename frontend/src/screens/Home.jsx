...
export default function Home() {
    ...
    const placeholderTrucks =['Cafe Vietnam', 
    'Kalamaki Greek Street Food', 'Paradise Cookies & Ice Cream' ,
     'Perro', 'Philly Jays Steaks','Savage Tacos', 'Smile Hotdog',
    'Sweets on Wheels', 'ThaiMex Cocina', 'The Bollywood Kitchen', 
   'The Taco Cartel', 'Tokyo Style', 'Yunas Bob', 'Creamy Boys', 
   'Pinch of Flavor', 'Pacifico Charbroiled Fish', 'Kogi', 
   'Dinas Dumpling', 'Salpicon', 'Original Herbivore', 
   '8E8 Thai Street Food', 'Babys Badass Burgers', 'Wafl', 
   'StopBye Cafe', 'Cerda Vega Tacos', 'Poutine Brothers', 
   "Uncle Al's Barbeque", 'Aloha Fridays', 'Dulce Europa Shaved Ice', 
   'Habibi Shack', 'Flaming Grain', 'Yalla', 'Bison Burger']

  const imagePaths = {
    'Cafe Vietnam': '../../food_truck_logos/cafevietnam.jpeg', 
  'Kalamaki Greek Street Food': '../../food_truck_logos/kalamaki.jpeg', 
  'Paradise Cookies & Ice Cream':'../../food_truck_logos/paradisecookiesandcream.jpeg'	,
  ...
  "Perro": 'We proudly serve one of the best tacos you will ever have. Everything starts with our Moms handmade flour tortilla imported from Tijuana Mexico topped with smoked steak grilled cheese and fresh vegetables.',
  ...
  "ThaiMex Cocina": 'Youll never have to choose between Thai and Mexican Food again! The Thai-Mex Cocina food truck offers mouthwatering, multicultural creations like doubly authentic tacos, quesadillas and noodles at your choosing of spicy garlic shrimp, chicken satay or crispy pork belly.',
  ...
  "Yunas Bob": 'Yunas Bob is LAs finest Korean Food on wheels. We love to see happy customers enjoying our authentic Korean dishes. Try the Bulgogi Beef Bowl with rice an1d vegetables or our signature Spicy Shrimp Bowl. Everything we serve is fresh, delicious and prepared to order. Yunas can often be found on the westside serving the community quality eats at affordable prices. We Cater too, for studio gigs, corporate events and private parties as well. Come find our truck and you will taste the difference!',
  "Creamy Boys": 'This is a popular style in New Zealand made from ice cream and fruit. You will often find it at the beach, a farmers market or a fruit shop.To make Real Fruit Ice Cream, us kiwis blend your choice of frozen fruits with a dairy or non-dairy ice cream. ',
  "Pinch of Flavor": 'You will never realize just how big a food trucks menu can be until you stop by Pinch of Flavor. Isis and Jael are dedicated to whipping up pristine made-to-order eats on the streets of Los Angeles, CA, all popping with traditional Mexican ingredients. This aint your average taco truck, but a gourmet establishment sporting a menu with unbelievably flavorful fare. Foodies across LA need to hit it up ASAP. The name is apt here. The bounty of tacos, burgers, and bowls are bursting with bold taste.',
  ...
  "Uncle Al's Barbeque": 'Uncle Al and Auntie K created LAs first and only street style BBQ food truck, where we take Los Angeles style street fare and infuse it with BBQ flavors we all know and love. With over 15 years of culinary and customer service we pride ourselves in providing a unique and memorable experience every time you visit. We cannot wait to see you and always remember to RUB.EAT. REPEAT. ',
        ...
        {display.length > 0 ? (
          <div className="min-h-100 w-75 d-flex flex-column justify-content-between gap-3">
            {display.slice(i, i + DELTA).map((title) => (
              <div className="mb-3">
                <FoodTruckCard name={title} text={descriptions[title]} imageURL={imagePaths[title]}/>
              </div>
            ))}
          </div>
        ) : (
