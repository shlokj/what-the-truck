    ...
    >
      ...
      <div style={column}>
        ...
        <div className="justify-content-end" style={image}>
          ...
          <p>
            ...
            may take a few days to reflect on our website. If you would like to
            report a bug, please any of the given email IDs.
          </p>
          <p>
            <h7>
              built with shlok's {}
      ...
      <div style={column}>
        ...
        <div align="left">
          ...
          <li>
            <a className="text-light" href="mailto: sidharthsudhir@g.ucla.edu">
